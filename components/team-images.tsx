      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <figure className="absolute h-auto" style={{ top: '45%', width: '41.67%', maxWidth: '320px' }} data-aos="fade-right">
              <Image src={TeamMosaic01} width="320" height="240" alt="Team mosaic 02" />
            </figure>
            <figure className="relative mx-auto h-auto" style={{ width: '78.13%', maxWidth: '600px' }} data-aos="fade-down" data-aos-delay="100">
              <Image src={TeamMosaic02} width="600" height="338" alt="Team mosaic 01" />
            </figure>
            ...
            <figure className="absolute h-auto" style={{ bottom: '10%', right: '0%', width: '70.78%', maxWidth: '320px'}} data-aos="fade-up" data-aos-delay="300">
              <Image src={TeamMosaic04} width="320" height="240" alt="Team mosaic 04" />
            </figure>
          </div>
        </div>
      </div>
